...
To perform all the operation we designed the data-path for the circuit. In order to be efficient and use the least amount of diferent components we organized the data-path as can be seen in image \ref{fig:path}. 
